...
if /I "%~1"=="start" (
    if not "%~2"=="" (
        python "%BASEDIR%scripts\itinfra.py" start %2 %3 %4 %5
        exit /b %ERRORLEVEL%
    )
...
:help
echo ===============================================================================
echo   ITINFRA — CLI RAPIDA A ZERO ATTRITO (v0.9.11)
echo ===============================================================================
echo   Uso: it ^<comando^> [opzioni]
echo.
echo   Comandi Rapidi:
echo     it start ^<slug^>   All-in-One Onboarding: inizializza, crea template e apre UI
echo     it start          Aggiorna il workspace e avvia l'IDE (Antigravity/Cursor)
echo     it scaffold ^<slug^> Auto-scaffold dei 10 template OKF v0.2 da manifesto
