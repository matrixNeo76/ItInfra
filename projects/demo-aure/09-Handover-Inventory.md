---
okf_version: "0.2"
id: "specification-demo-aure-handover-01"
title: "Handover & Inventory — Progetto Demo-aure"
type: "specification"
...
related_docs:
  ...
  - "guide-demo-aure-sop-runbook-01"
depends_on:
  - "architecture-demo-aure-asbuilt-01"
  - "specification-demo-aure-atp-01"
supersedes: null
...
relations:
  ...
  - targetTitle: "SOP / Runbook"
    targetId: "guide-demo-aure-sop-runbook-01"
    relationType: "references"
    weight: 0.95
...
|-------|-------|------|---------------|
| Committente | Sponsor | `<nome>` | `Cliente Demo-aure` |
| Committente | Network Operations Lead | `<nome>` | `Cliente Demo-aure` |
...
|-------|------|---------------|------|-------|
| Sponsor (cliente) | `<nome>` | `Cliente Demo-aure` | `<data>` | _______________________ |
| NO Lead (cliente) | `<nome>` | `Cliente Demo-aure` | `<data>` | _______________________ |
