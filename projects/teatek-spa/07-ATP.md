---
okf_version: "0.2"
id: "specification-teatek-spa-atp-01"
title: "ATP — Infrastruttura HA Metro Cluster OpenStor"
type: "specification"
...
| Cliente — NO | `<nome>` | `T.E.A. TEK S.P.A.` | `<...>` |
| Cliente — Security Officer | `<nome>` | `T.E.A. TEK S.P.A.` | `<...>` |
...
| Network Operations (cliente) | `<nome>` | `T.E.A. TEK S.P.A.` | `<data>` | _______________________ |
| Security Officer (cliente) | `<nome>` | `T.E.A. TEK S.P.A.` | `<data>` | _______________________ |
| Sponsor / cliente finale | `<nome>` | `T.E.A. TEK S.P.A.` | `<data>` | _______________________ |
