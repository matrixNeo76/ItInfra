...
3. CONFRONTO STRICT GROUNDING CON AS-BUILT & LLD: Ogni apparato, IP, subnet, VLAN o servizio citato DEVE corrispondere a quanto registrato in [[architecture-teatek-spa-asbuilt-01]] o [[architecture-teatek-spa-lld-01]].
...
| **Apparati / Nodi Impattati** | `<Hostname / IP apparati>` | Rif. [[architecture-teatek-spa-asbuilt-01]] |
...
|---------|-----------|-------------------------------|-------|----------|-------------------------|-------|
| CAPA-01 | **Monitoring** | Creazione sonda automatica per rilevare l'anomalia prima del blocco | `<Owner>` | `2026-09-15` | [[guide-teatek-spa-sop-runbook-01]] | `[Aperta / In Corso / Chiusa]` |
| CAPA-02 | **Architettura** | Aggiornamento configurazione o hardening del servizio | `<Owner>` | `2026-09-15` | [[architecture-teatek-spa-lld-01]] | `[Aperta / In Corso / Chiusa]` |
| CAPA-03 | **Documentale** | Allineamento As-Built e manuale operativo | `<Owner>` | `2026-09-15` | [[architecture-teatek-spa-asbuilt-01]] | `[Aperta / In Corso / Chiusa]` |
| CAPA-04 | **Testing** | Integrazione test specifico nella suite ATP per futuri rilasci | `<Owner>` | `2026-09-15` | [[specification-teatek-spa-atp-01]] | `[Aperta / In Corso / Chiusa]` |
...
- [[architecture-teatek-spa-asbuilt-01]]: Aggiornati parametri di rete/configurazione.
- [[architecture-teatek-spa-lld-01]]: Aggiornate sezioni architetturali impattate.
- [[guide-teatek-spa-sop-runbook-01]]: Aggiunta procedura operativa di recovery nel capitolo troubleshooting.
- [[specification-teatek-spa-atp-01]]: Aggiunto caso di test preventivo.
