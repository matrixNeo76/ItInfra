---
okf_version: "0.2"
id: "specification-teatek-spa-handover-01"
title: "Handover & Inventory — Infrastruttura HA Metro Cluster OpenStor"
type: "specification"
...
related_docs:
  - "specification-teatek-spa-rsd-01"
  - "architecture-teatek-spa-asbuilt-01"
...
relations:
  - targetTitle: "As-Built Documentation"
    targetId: "architecture-teatek-spa-asbuilt-01"
  ...
  - targetTitle: "RSD/URS — Requirements Specification Document"
    targetId: "specification-teatek-spa-rsd-01"
...
|-------|-------|------|---------------|
| Committente | Sponsor | `<nome>` | `T.E.A. TEK S.P.A.` |
| Committente | Network Operations Lead | `<nome>` | `T.E.A. TEK S.P.A.` |
...
|-------|------|---------------|------|-------|
| Sponsor (cliente) | `<nome>` | `T.E.A. TEK S.P.A.` | `<data>` | _______________________ |
| NO Lead (cliente) | `<nome>` | `T.E.A. TEK S.P.A.` | `<data>` | _______________________ |
| Security Officer (cliente) | `<nome>` | `T.E.A. TEK S.P.A.` | `<data>` | _______________________ |
