---
okf_version: "0.2"
id: "specification-roberto-viola-atp-01"
title: "ATP — Progetto Infrastruttura Roberto-viola"
type: "specification"
...
related_docs:
  ...
  - "specification-roberto-viola-handover-01"
depends_on:
  - "architecture-roberto-viola-asbuilt-01"
supersedes: null
superseded_by: null
...
relations:
  ...
  - targetTitle: "Handover & Asset Inventory"
    targetId: "specification-roberto-viola-handover-01"
    relationType: "references"
    weight: 0.95
...
| Cliente — NO | `<nome>` | `Studio Legale Avv. Roberto Viola` | `<...>` |
| Cliente — Security Officer | `<nome>` | `Studio Legale Avv. Roberto Viola` | `<...>` |
...
| Network Operations (cliente) | `<nome>` | `Studio Legale Avv. Roberto Viola` | `<data>` | _______________________ |
| Security Officer (cliente) | `<nome>` | `Studio Legale Avv. Roberto Viola` | `<data>` | _______________________ |
| Sponsor / cliente finale | `<nome>` | `Studio Legale Avv. Roberto Viola` | `<data>` | _______________________ |
