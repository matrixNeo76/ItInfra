---
okf_version: "0.2"
id: "specification-roberto-viola-handover-01"
title: "Handover & Inventory — Progetto Infrastruttura Roberto-viola"
type: "specification"
...
related_docs:
  - "specification-roberto-viola-rsd-01"
  - "architecture-roberto-viola-asbuilt-01"
  - "specification-roberto-viola-atp-01"
...
relations:
  ...
  - targetTitle: "RSD/URS — Requirements Specification Document"
    targetId: "specification-roberto-viola-rsd-01"
...
|-------|-------|------|---------------|
| Committente | Sponsor | `<nome>` | `Studio Legale Avv. Roberto Viola` |
| Committente | Network Operations Lead | `<nome>` | `Studio Legale Avv. Roberto Viola` |
...
|----------|---------|------------|-----------|------|-------|------------------|---------|---------------|-------------------|
| SRV-01 | `<Dell PowerEdge R750>` | `<ABC1234>` | `<AST-001>` | R01 | U38-37 | `<AA:BB:CC:DD:EE:01>` | 10.10.50.101 | `2026-09-15` | `2026-09-15` |
...
|-----------|--------|---------------|------|--------------|-----------|------|
| CTR-001 | Dell ProSupport Plus | SRV-01/02/03 | 5y NBD + 24x7 phone | `2026-09-15` | `2026-09-15` | Incluso firmware update on-site |
| CTR-002 | Cisco SMARTnet | sw-core, sw-tor | 5y 24x7x4 | `2026-09-15` | `2026-09-15` | Spare parts on-site 4h |
| CTR-003 | NetApp Support | stor-01, stor-dr | 5y Premium 24x7 | `2026-09-15` | `2026-09-15` | Incl. software subscription |
| CTR-004 | FortiCare + UTM | fw-01, fw-02 | 3y 24x7 | `2026-09-15` | `2026-09-15` | Rinnovo richiesto entro `<data>` |
| CTR-005 | Veeam Premium Care | bkp-01 | 3y | `2026-09-15` | `2026-09-15` | Incl. upgrade major releases |
| CTR-006 | APC Standard | UPS-01/02 | 3y | `2026-09-15` | `2026-09-15` | Battery replace coperto |
...
|----------|--------|-------------------|----------|------|--------------|---------------|------|
| vSphere Enterprise Plus | VMware | `<riferimento vault>` | 3 CPU | subscription | `2026-09-15` | `2026-09-15` | Rinnovo annuale |
| vCenter Standard | VMware | `<riferimento vault>` | 1 istanza | subscription | `2026-09-15` | `2026-09-15` | Rinnovo annuale |
| vSAN Advanced | VMware | `<riferimento vault>` | 3 CPU | subscription | `2026-09-15` | `2026-09-15` | In cluster |

### 4.2 Storage Software

| Prodotto | Vendor | Chiave | Quantità | Tipo | Scadenza |
|----------|--------|--------|----------|------|----------|
| ONTAP Standard | NetApp | `<riferimento vault>` | 1 cluster | subscription | `2026-09-15` |
| SnapMirror | NetApp | `<riferimento vault>` | 1 cluster | subscription | `2026-09-15` |

### 4.3 Sicurezza

| Prodotto | Vendor | Chiave | Quantità | Tipo | Scadenza |
|----------|--------|--------|----------|------|----------|
| FortiGate UTM bundle | Fortinet | `<riferimento vault>` | 2 appliance | subscription | `2026-09-15` |
| Nessus Professional | Tenable | `<riferimento vault>` | 1 console | subscription | `2026-09-15` |

### 4.4 Backup

| Prodotto | Vendor | Chiave | Quantità | Tipo | Scadenza |
|----------|--------|--------|----------|------|----------|
| Veeam Backup & Replication Enterprise Plus | Veeam | `<riferimento vault>` | 1 instance + 1 socket | subscription | `2026-09-15` |
| Veeam Cloud Connect | `<provider>` | `<account ID>` | 1 subscription | subscription | `2026-09-15` |

### 4.5 Sistema Operativo e Servizi

| Prodotto | Vendor | Chiave | Quantità | Tipo | Scadenza |
|----------|--------|--------|----------|------|----------|
| Windows Server 2022 STD | Microsoft | `<riferimento vault>` | `<n>` licenze | perpetua + SA | `2026-09-15` |
| Windows Server CAL | Microsoft | `<riferimento vault>` | `<n>` CAL | perpetua + SA | `2026-09-15` |
| RHEL Subscription | Red Hat | `<riferimento vault>` | `<n>` socket | subscription | `2026-09-15` |

### 4.6 Riepilogo Scadenze (prossimi 12 mesi)

| Data | Prodotto | Asset | Importo stimato | Azione richiesta |
|------|----------|-------|----------------|-------------------|
| `2026-09-15` | FortiGate UTM bundle | fw-01/02 | `<€>` | Rinnovo entro 60gg |
| `2026-09-15` | vSphere Enterprise Plus | SRV-01/02/03 | `<€>` | Rinnovo entro 90gg |
| `2026-09-15` | `<...>` | `<...>` | `<€>` | `<...>` |
...
|-------|------|---------------|------|-------|
| Sponsor (cliente) | `<nome>` | `Studio Legale Avv. Roberto Viola` | `<data>` | _______________________ |
| NO Lead (cliente) | `<nome>` | `Studio Legale Avv. Roberto Viola` | `<data>` | _______________________ |
| Security Officer (cliente) | `<nome>` | `Studio Legale Avv. Roberto Viola` | `<data>` | _______________________ |
