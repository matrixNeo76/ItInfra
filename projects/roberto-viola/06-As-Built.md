---
okf_version: "0.2"
id: "architecture-roberto-viola-asbuilt-01"
title: "As-Built — Progetto Infrastruttura Roberto-viola"
type: "architecture"
...
|----------|---------|--------------------|-----------|------|-------|---------|--------|-----|-----|----------------|-----------|----------|
| srv-viola-01 | HP Z6 G4 Workstation (AI Ready) | HP-Z6G4-VIOLA-01 | AST-VIOLA-001 | Standalone | Desk | 00:1E:67:D2:11:AA | 192.168.20.10 | 2x Xeon Silver 4108 | 128 GB ECC | 2x 1TB NVMe + 2x 1TB SSD | Hyper-V (Win 2022) | 2.90 |

### 4.2 Switch

| Hostname | Modello | Service Tag | Asset Tag | Rack | U-pos | MAC management | IP MGMT | Versione OS | Firmware |
|----------|---------|------------|-----------|------|-------|---------------|---------|-------------|----------|
| sw-lan-01 | Gigabit Managed Switch 24p | SW-GEST-VIOLA-01 | AST-VIOLA-010 | Standalone | Wall | 00:1E:67:D2:11:BB | 192.168.20.2 | SwitchOS v2 | 2.16 |
