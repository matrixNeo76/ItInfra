---
okf_version: "0.2"
id: "guide-<project_slug>-rca-<incident_id>"
...
3. CONFRONTO STRICT GROUNDING CON AS-BUILT & LLD: Ogni apparato, IP, subnet, VLAN o servizio citato DEVE corrispondere a quanto registrato in [[architecture-<project_slug>-asbuilt-01]] o [[architecture-<project_slug>-lld-01]].
4. METODO DEI 5 PERCHÉ: Identificare la catena logica senza saltare passaggi intermedi.
5. CREDENZIALI: Nessun secret in chiaro. Usare sempre riferimenti simbolici vault://it/projects/<slug>/...
...
| **Apparati / Nodi Impattati** | `<Hostname / IP apparati>` | Rif. [[architecture-<project_slug>-asbuilt-01]] |
...
|---|----------------------|-------------|--------------------------------|------------|
| 1 | `<Descrizione azione temporanea, es. routing provvisorio>` | `<Operatore>` | `<Es. banda ridotta, mancata ridondanza>` | `<YYYY-MM-DD>` |
...
|---------|-----------|-------------------------------|-------|----------|-------------------------|-------|
| CAPA-01 | **Monitoring** | Creazione sonda automatica per rilevare l'anomalia prima del blocco | `<Owner>` | `<YYYY-MM-DD>` | [[guide-<project_slug>-sop-runbook-01]] | `[Aperta / In Corso / Chiusa]` |
| CAPA-02 | **Architettura** | Aggiornamento configurazione o hardening del servizio | `<Owner>` | `<YYYY-MM-DD>` | [[architecture-<project_slug>-lld-01]] | `[Aperta / In Corso / Chiusa]` |
| CAPA-03 | **Documentale** | Allineamento As-Built e manuale operativo | `<Owner>` | `<YYYY-MM-DD>` | [[architecture-<project_slug>-asbuilt-01]] | `[Aperta / In Corso / Chiusa]` |
| CAPA-04 | **Testing** | Integrazione test specifico nella suite ATP per futuri rilasci | `<Owner>` | `<YYYY-MM-DD>` | [[specification-<project_slug>-atp-01]] | `[Aperta / In Corso / Chiusa]` |
...
- [[architecture-<project_slug>-asbuilt-01]]: Aggiornati parametri di rete/configurazione.
- [[architecture-<project_slug>-lld-01]]: Aggiornate sezioni architetturali impattate.
- [[guide-<project_slug>-sop-runbook-01]]: Aggiunta procedura operativa di recovery nel capitolo troubleshooting.
- [[specification-<project_slug>-atp-01]]: Aggiunto caso di test preventivo.
...
- [ ] Eventuali credenziali usate riferite tramite `vault://it/projects/<slug>/...`.
...
|-------|----------------|-------------------|------|
| **Lead Investigator** | `<Nome>` | `[Approvato digitalmente]` | `<YYYY-MM-DD>` |
| **Service Manager / Reviewer** | `<Nome>` | `[Approvato digitalmente]` | `<YYYY-MM-DD>` |
| **Responsabile IT Cliente** | `<Nome>` | `[Per presa visione e accettazione]` | `<YYYY-MM-DD>` |
