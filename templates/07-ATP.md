...
title: "ATP — <titolo progetto, es. Collaudo Infrastruttura DC Milano>"
type: "specification"
...
| Cliente — NO | `<nome>` | `<cliente>` | `<...>` |
| Cliente — Security Officer | `<nome>` | `<cliente>` | `<...>` |
...
| Network Operations (cliente) | `<nome>` | `<cliente>` | `<data>` | _______________________ |
| Security Officer (cliente) | `<nome>` | `<cliente>` | `<data>` | _______________________ |
| Sponsor / cliente finale | `<nome>` | `<cliente>` | `<data>` | _______________________ |
