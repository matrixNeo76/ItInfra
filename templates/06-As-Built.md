...
title: "As-Built — <titolo progetto, es. Infrastruttura DC Milano>"
type: "architecture"
...
**Stato:** `<status>`
**Data installazione:** `<YYYY-MM-DD>`
**Data cutover:** `<YYYY-MM-DD>`
...
|----------|---------|--------------------|-----------|------|-------|---------|--------|-----|-----|----------------|-----------|----------|
| SRV-01 | `<Dell PowerEdge R750>` | `<ABC1234>` | `<AST-001>` | R01 | U38-37 | `<AA:BB:CC:DD:EE:01>` | 10.10.50.101 | 2x Xeon Gold 6338 (32c) | 256 GB | 2x 480 SSD RAID1 | `<ESXi 8.0 U2>` | `<3.10.10.10>` |
...
|----------|---------|----------------------|------|
| fw-01 admin | `admin` | `vault://it/<project>/fw-01/admin` | Rotazione ogni 90gg |
| fw-02 admin | `admin` | `vault://it/<project>/fw-02/admin` | Rotazione ogni 90gg |
| sw-core-01 admin | `admin` | `vault://it/<project>/sw-core-01/admin` | Rotazione ogni 90gg |
| stor-01 admin | `admin` | `vault://it/<project>/stor-01/admin` | Rotazione ogni 90gg |
| vCenter admin | `administrator@vsphere.local` | `vault://it/<project>/vcenter/admin` | MFA abilitata |
| bkp-01 admin | `backup-admin` | `vault://it/<project>/bkp-01/admin` | Rotazione ogni 90gg |
| UPS/PDU admin | `admin` | `vault://it/<project>/ups/admin` | Rotazione ogni 180gg |
