...
title: "SOP/Runbook — <titolo progetto, es. Operazioni Infrastruttura DC Milano>"
type: "guide"
...
Connect-VIServer -Server vcenter.<domain> -User "<vault://it/<project>/vcenter/admin>"
...
### 4.2 Prerequisiti
- [ ] Elenco credenziali da ruotare (consultare vault `vault://it/<project>/`)
...
vault kv put vault://it/<project>/fw-01/admin \
  password="$NEW_PW" \
